        ...
        <div className={styles.navDrawerButton}>
            ...
            <svg className={styles.buttonContainer} onClick={() => toggle()}>
                <g id="layer1">
                    ...
                    d="m 4.8823464,4.1102541 44.2857196,0 0,2.57142 -44.2857196,0 z"
                    id="rect_top"
                    />
                    <path
                    id="rect_middle"
                    d="m 4.9966364,13.938824 44.2857196,0 0,2.57142 -44.2857196,0 z"
                    className={showDrawer ? middle_open : styles.rectstyle} />
                    <path
                    className={showDrawer ? bottom_open : styles.rectstyle}   
                    d="m 4.9966364,23.338824 44.2857196,0 0,2.57142 -44.2857196,0 z"
                    id="rect_bottom" />
                </g>
            </svg>
        </div> 
